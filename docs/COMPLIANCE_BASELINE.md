...
| Despacho durable de mensajes | A.8.15 | 6.9 | — | V4, V7 | evidencia | #380, ADR-0020 | T | parcial — contrato y receptor con outbox transaccional, auditoría, ID estable y recuperación explícita; probados rollback, aislamiento, Redis sin respuesta y reinicio. Falta migrar los emisores. No garantiza exactly-once frente al proveedor externo |
